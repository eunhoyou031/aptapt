...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", default='/data/calvin_dataset/task_ABC_D', type=str)
    parser.add_argument("--output_dir", default='/data/calvin_dataset/lmdb_datasets/task_ABC_D', type=str)
